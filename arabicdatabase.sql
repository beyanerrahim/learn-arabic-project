...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 06 Eyl 2021, 21:19:12
...
--
-- Tablo için tablo yapısı `massages`
--
...
--
-- Tablo için tablo yapısı `rol_per`
--
...
(15, 'beyan', 'bayanrhayyem@gmail.com', '98b0bd7eea82dea77a200b16f33400dd', '1998-08-11', 'female', 'syria', 1, 0),
(20, 'beyan', 'beyanerrahim2468@gmail.com', '98b0bd7eea82dea77a200b16f33400dd', '2011-08-04', 'female', 'syria', 0, 0),
(36, ' liin almolhem', 'liinalmolhem.2001@gmail.com', 'fca154d64f34dda1322c4888c4da90cf', '2009-10-10', 'syria', 'famale', 0, 0),
(37, 'sally', 'salialmolhem@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '1998-12-09', 'famale', 'syria', 1, 828405),
(38, 'muhammed', 'star.m.52716@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '0000-00-00', 'male', 'syria', 0, 0),
(39, ' selin almolhem', 'selinalmolhem@gmail.com', 'fcea920f7412b5da7be0cf42b8c93759', '2010-10-10', 'syria', 'famale', 0, 0),
...
--
ALTER TABLE `exams`
  MODIFY `exam_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
-- Tablo için AUTO_INCREMENT değeri `massages`
--
ALTER TABLE `massages`
  MODIFY `massage_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `users`
  MODIFY `user_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
